...
if("TRUE" STREQUAL "TRUE")
  set(my_pcl_tutorial_SOURCE_PREFIX /home/u180120/ProjectWork/PCLWorkspace/src/my_pcl_tutorial)
  set(my_pcl_tutorial_DEVEL_PREFIX /home/u180120/ProjectWork/PCLWorkspace/devel)
  ...
  set(my_pcl_tutorial_INSTALL_PREFIX /home/u180120/ProjectWork/PCLWorkspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'u180120 <u180120@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'my_pcl_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/u180120/ProjectWork/PCLWorkspace/src/my_pcl_tutorial/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/u180120/ProjectWork/PCLWorkspace/devel/lib;/home/u180120/ProjectWork/PCLWorkspace/devel/lib;/opt/ros/kinetic/lib)
